...
| the port is 3× low against LabVIEW | working notes, 2026-09-01 | The reference moved: LabVIEW's own τ fell from 190 ns to 71 ns over three hours, so runs hours apart are not a comparison. The pair eight minutes apart is in `history/HANDOVER-2026-09-02.md`. |
